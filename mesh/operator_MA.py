...
def get_args(argv=None):
    ...
    parser.add_argument('--epochs_adam', default=200, type=int, help='number of epochs of Adam optimizer') # 200
    parser.add_argument('--epochs_lbfgs', default=0, type=int, help='number of epochs of LBFGS optimizer') # 25, 0
    parser.add_argument('--epochs_rf', default=50, type=int, help='number of epochs of random feature')
...
if __name__ == "__main__":
    ...
    plot_loss(args, loss_in, loss_bound, train_std_list, train_minmax_list, test_std_list, test_minmax_list)
