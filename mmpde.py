...
def main(args: argparse):
    ...
    if args.moving_mesh == False:
        ...
        if args.experiment == 'cy':
            ...
            checkpoint = torch.load('mesh/cy_cp/new_2023-08-21 13:36:52.839070test_cyrfTrue_boundTrue_50_300_4_0_160_120_1000_1500_[4, 3]_0.0002_[16, 512]_0.2', \
            ...
            if base_resolution[1] == 48:
                checkpoint = torch.load('mesh/burgers_rf/new_2023-08-05 04:48:26.561599test_burgersrfTrue_boundTrue_50_300_4_0_160_120_1000_5000_7_0.0002_[32, 512]_0.2', map_location=lambda storage, loc: storage)
